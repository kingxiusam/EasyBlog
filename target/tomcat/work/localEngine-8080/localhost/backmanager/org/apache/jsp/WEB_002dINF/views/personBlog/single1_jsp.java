...
public final class single1_jsp extends org.apache.jasper.runtime.HttpJspBase
...
static {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    String path = request.getContextPath();
      ...
      out.write("                            <li style=\"color: #0d90d1\">更多<a style=\"color: #0d90d1\" href=\"");
      out.print(path);
      out.write("/single/showMoreSingle.html\">>></a></li>\n");
      out.write("                            <li><a href=\"");
      out.print(path);
      ...
      out.write("                <article class=\"single-post-content row m0 post\">\n");
      ...
      out.write("                        <a href=\"#\"><img src=\"");
      out.print(path);
      out.write("/images/posts/6.jpg\" alt=\"\"></a>\n");
      out.write("                    </div>\n");
      out.write("                    <div class=\"post-content row\">\n");
      out.write("                        <h4>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</h4>\n");
      out.write("                        <br>\n");
      ...
      out.print(path);
      out.write("/images/posts/gallery/1.jpg\" alt=\"\"></li>\n");
      out.write("                                    <li><img src=\"");
      out.print(path);
      out.write("/images/posts/gallery/2.jpg\" alt=\"\"></li>\n");
      out.write("                                    <li><img src=\"");
      out.print(path);
      out.write("/images/posts/gallery/3.jpg\" alt=\"\"></li>\n");
      out.write("                                    <li><img src=\"");
      out.print(path);
      out.write("/images/posts/gallery/4.jpg\" alt=\"\"></li>\n");
      out.write("                                    <li><img src=\"");
      out.print(path);
      out.write("/images/posts/gallery/1.jpg\" alt=\"\"></li>\n");
      out.write("                                    <li><img src=\"");
      ...
      out.write("                                    <li><img src=\"");
      out.print(path);
      out.write("/images/posts/gallery/s1.jpg\" alt=\"\"></li>\n");
      out.write("                                    <li><img src=\"");
      out.print(path);
      out.write("/images/posts/gallery/s2.jpg\" alt=\"\"></li>\n");
      out.write("                                    <li><img src=\"");
      out.print(path);
      out.write("/images/posts/gallery/s3.jpg\" alt=\"\"></li>\n");
      out.write("                                    <li><img src=\"");
      out.print(path);
      out.write("/images/posts/gallery/s4.jpg\" alt=\"\"></li>\n");
      out.write("                                    <li><img src=\"");
      out.print(path);
      out.write("/images/posts/gallery/s1.jpg\" alt=\"\"></li>\n");
      out.write("                                    <li><img src=\"");
      ...
      // /WEB-INF/views/personBlog/single1.jsp(222,28) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setVar("message");
      // /WEB-INF/views/personBlog/single1.jsp(222,28) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/personBlog/single1.jsp(222,28) '${communityList}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${communityList}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      ...
      try {
        ...
        if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write("                                        <a href=\"#\"><img src=\"");
            out.print(path);
            out.write("/images/posts/c2s.jpg\" alt=\"\" class=\"img-circle\"></a>\n");
            out.write("                                    </div>\n");
            ...
            // /WEB-INF/views/personBlog/single1.jsp(231,40) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            ...
            if (_jspx_eval_c_005fif_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              do {
                ...
                out.write("                                        <a href=\"");
                out.print(path);
                out.write("/community/1/deleteCommunity.html?messageId=");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${userName}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/1.html\" id=\"messageForm\" method=\"post\" class=\"comment-form row\">\n");
