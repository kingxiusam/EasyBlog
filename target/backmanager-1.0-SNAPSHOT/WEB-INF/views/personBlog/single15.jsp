...
所以可以用更少的机器来加速应用，也就提升了资源的利用率。
                            ...
                            <c:forEach var="message" items="${communityList}">
                                <div class="media comment reply">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p>${message.message}</p>
                                        <c:if test="${message.owner==userName}">|<a href="<%=path%>/community/15/deleteCommunity.html?messageId=${message.messageId}" class="reply-link" onclick="delConfirm();">delete</a></c:if>
                                    </div>
                                </div>
                ...
                <form action="<%=path%>/community/addOneCommunity/${userName}/15.html" method="post" id="messageForm" class="comment-form row">
