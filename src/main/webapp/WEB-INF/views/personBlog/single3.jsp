            ...
            <div class="col-sm-12 single-post-contents">
                <article class="single-post-content v2 v2p1 row m0 post">
                    <header class="row">                        
                        ...
                        <h5 class="post-meta">
                            By <a href="#">HuangDong</a> | <a href="#" class="date">feb 17, 2016</a>
                        </h5>
                    </header>
                            ...
                            <div class="col-sm-4 post-author-about">
                                <div class="media">
                                    <div class="media-left">
                                        <a href="#"><img src="<%=path%>/images/author.png" alt="" class="img-circle"></a>
                                    </div>
                                    <div class="media-body">
                                        <h3><a href="#">HuangDong</a></h3>
                                        <h5>small title</h5>
                                        <ul class="nav social-nav white">
                                            <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                                            <li><a href="#"><i class="fa fa-facebook-official"></i></a></li>
                            ...
                            <c:forEach var="message" items="${communityList}">
                                <div class="media comment reply">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <c:if test="${message.owner==userName}">   <p>${message.message}</p>
                                        | <a href="<%=path%>/community/3/deleteCommunity.html?messageId=${message.messageId}" class="reply-link" onclick="delConfirm();">delete</a>
                                        </c:if>
                                    </div>
                                </div>
                ...
                <form action="<%=path%>/community/addOneCommunity/3.html" method="post" id="messageForm" class="comment-form row">
